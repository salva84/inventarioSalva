...
<body style="background: #edf2f7;" class="d-flex align-items-center justify-content-center min-vh-100">
    ...
    <div class="card shadow-sm" style="max-width:720px;border-radius:0.5rem;">
        <img src="getimages.php?image=<?php echo $row['image'];?>&type=<?php echo VIDEOGAMES;?>" alt="<?php echo $row['videogamename'];?>" title="<?php echo $row['videogamename'];?>" class="card-img-top" style="object-fit:cover;max-height:320px;">
        <div class="card-body">
            <div class="d-flex align-items-center">
                <div class="flex-grow-1">
                    <h4 class="h5 mb-1"><?php echo $row['videogamename'];?> <span class="fw-normal">(<?php echo $row['consolename'];?> · <?php echo $row['genre'];?>)</span></h4>
