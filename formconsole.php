            ...
            <div class="d-flex flex-column flex-grow-1 overflow-hidden" style="margin-left:256px;">
                ...
                <main class="flex-grow-1 overflow-x-hidden overflow-y-auto" style="background-color:#e5e7eb;">
                    <div class="container" style="padding-left:1.5rem;padding-right:1.5rem;padding-top:2rem;padding-bottom:2rem;margin-left:auto;margin-right:auto;">
                        <h3 style="font-size:1.875rem;line-height:2.25rem;font-weight:500;color:#374151;margin:0;">Añadir consola</h3>
                        <div class="mt-8">
                        </div>
                        <div class="mt-4">
                            <div class="py-2">
                                <div class="bg-white rounded shadow-sm" style="border:1px solid #e5e7eb;">
                                    <form class="w-100" style="padding:1.5rem;" action="<?php echo $_SERVER["PHP_SELF"];?>?console=<?php echo isset($_GET['console']) ? $_GET['console']  : "";?>" enctype="multipart/form-data" method="POST">
                                        <input type="hidden" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        <div class="row g-3">
                                            <div class="col-md-4">
                                              <label class="form-label" for="consolename">Nombre consola</label>
                                              <input class="form-control <?php if (!empty($messages['consolename'])) echo 'is-invalid'; ?>" id="consolename" name="consolename" value="<?php echo isset($row['consolename']) ? $row['consolename'] : "";?>" type="text" placeholder="Super Nintendo">
                                              <div class="invalid-feedback"><?php echo $messages['consolename'] ?></div>
                                            </div>
                                            <div class="col-md-4">
                                            ...
                                            <div class="col-md-4">
                                              <label class="form-label" for="maker">Fabricante</label>
