                    ...
                    <div class="container py-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <div class="p-3 bg-primary bg-opacity-75 rounded-circle me-3">
                                        ...
                                        <div>
                                            <h4 class="h5 mb-1"><?php echo $countConsoles; ?></h4>
                                            <div class="text-muted small">Total consolas</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <div class="p-3 bg-warning bg-opacity-75 rounded-circle me-3">
                                        ...
                                        <div>
                                            <h4 class="h5 mb-1"><?php echo $sumConsoles;?></h4>
                            ...
                            <div class="col-12 col-md-6 col-xl-4">
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body d-flex align-items-center">
                                        <div class="p-3 bg-danger bg-opacity-75 rounded-circle me-3">
                                            <svg class="text-white" style="width:32px;height:32px;" viewBox="0 0 28 28" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div>
                                            <h4 class="h5 mb-1"><?php echo $lastAdquisition; ?></h4>
                                            <div class="text-muted small">Última adquisición</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-3">
                                                    <div class="fw-medium"><?php echo $row['consolename'];?></div>
                                        ...
                                        <td class="text-end">
                                            <a href="./viewconsole.php?console=<?php echo $row['id']; ?>" class="link-primary">Ver</a>  
                                        </td>
                                        <td class="text-end">
                                            <a href="./formconsole.php?console=<?php echo $row['id']; ?>" class="link-primary">Editar</a>
                                        </td>
                                        <td class="text-end">
                                            <a href="./consoles.php?delete=<?php echo $row['id']; ?>&csrf_token=<?php echo $_SESSION['csrf_token']; ?>" class="link-danger" id="delete">Borrar</a>
                                        </td>                                                    
                                    </tr>
                                    <?php } 
                                    ?>
