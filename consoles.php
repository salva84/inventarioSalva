                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex align-items-center px-3 py-4 bg-white rounded shadow-sm">
                                    ...
                                    <div>
                                        <h4 class="h4 fw-semibold mb-1" style="color:#374151;"><?php echo $countConsoles; ?></h4>
                                        <div class="text-muted">Total consolas</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6 col-xl-4">
                                <div class="d-flex align-items-center px-3 py-4 bg-white rounded shadow-sm">
                                    ...
                                    <div>
                                        <h4 class="h4 fw-semibold mb-1" style="color:#374151;"><?php echo $sumConsoles;?></h4>
